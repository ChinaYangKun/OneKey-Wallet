...
[IMPORTANT] This repo has been deprecated due to a lot of updates and changes, please go to OneKey [official project page](https://github.com/OneKeyHQ) to find the repo or code you need.
